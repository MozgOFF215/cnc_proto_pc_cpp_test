...
LDFLAGS = # libs
OBJS = sometests.o arduino.o controller.o state.o parser_my.o

$(PROG) : $(OBJS)
	$(CC) $(LDFLAGS) -o $(PROG) $(OBJS)

sometests.o : test/sometests.cpp test/arduino.h src/controller.h src/parser_my.h src/state.h include/enums.h include/macros.h
